...
{
	channelPtr = [csoundObj getInputChannelPtr:@"VolumeValue" channelType:CSOUND_CONTROL_CHANNEL];
    cachedValue = value;
    self.cacheDirty = YES;
...
{
	cachedValue = ((UIKnobVolume*)sender).value;
    self.cacheDirty = YES;
}
