...
//  waveTerrain
//
//  Created by David Moya on 23/03/2014.
//  Copyright (c) 2014 David Moya. All rights reserved.
//

#import "VolumePanB.h"

@implementation VolumePanB
...
- (void)drawRect:(CGRect)rect
{
    ...
    NSString* textContent = @"Interaction, variables";
    
    
    //// Rounded Rectangle Drawing
    UIBezierPath* roundedRectanglePath = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(0.5, -1, 289, 151.5) cornerRadius: 10];
    [color2 setFill];
    ...
    UIBezierPath* roundedRectangle3Path = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(3.5, 2.5, 283.5, 144) cornerRadius: 10];
    ...
    //// Text Drawing
    CGRect textRect = CGRectMake(-8, 262, 85, 26);
