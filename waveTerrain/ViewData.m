...
- (void)drawRect:(CGRect)rect
{
    ...
    UIBezierPath* roundedRectanglePath = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(0, 0.5, 68.5, 431) cornerRadius: 10];
    [color2 setFill];
    ...
    UIBezierPath* roundedRectangle3Path = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(3.5, 2.5, 62, 425.5) cornerRadius: 10];
    ...
    //// Text Drawing
    CGRect textRect = CGRectMake(-8, 403, 85, 26);
