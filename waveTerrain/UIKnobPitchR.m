...
{
	channelPtr = [csoundObj getInputChannelPtr:@"ReverbPitchValue" channelType:CSOUND_CONTROL_CHANNEL];
    cachedValue = value;
    self.cacheDirty = YES;
...
{
	cachedValue = ((UIKnobPitchR*)sender).value;
    self.cacheDirty = YES;
}
